...
if __name__ == "__main__":
    generate_archive("tests/fixtures/bidaf/experiment.json", "tests/fixtures/bidaf/serialization", exist_ok=True)
    ...
    generate_archive("tests/fixtures/srl/experiment.json", "tests/fixtures/srl/serialization", exist_ok=True)
