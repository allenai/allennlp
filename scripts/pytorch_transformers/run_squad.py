...
from scripts.multiqa.utils_squad import (read_squad_examples, convert_examples_to_features,
...
from scripts.multiqa.utils_squad_evaluate import EVAL_OPTS, main as evaluate_on_squad
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    elastic_train_metrics.update({'batch_num_total': step})
                    elastic_train_metrics.update({'epoch': epoch_number})
                    elastic_train_metrics.update({'epoch_metrics/loss': (tr_loss - logging_loss) / args.logging_steps})
                    elastic_train_metrics.update({'experiment_name': args.exp_name})
