...
MODULES_THAT_NEED_NO_DOCS: Set[str] = {
        ...
        # Deprecated in favor of allennlp.models.shuffled_sentence_lm
        'allennlp.model.bidirectional_lm',
        # Deprecated in favor of
        # allennlp.modules.token_embedders.shuffled_sentence_language_model_token_embedder
        'allennlp.model.modules.token_embedders.bidirectional_language_model_token_embedder'
