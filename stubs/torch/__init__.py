from typing import Sequence, Optional, overload, Union, Tuple, TypeVar, Any
...
def gather(input: TV, dim: int, index: TV, out: Optional[TV] = None) -> TV: ...
...
@overload
def matmul(tensor1: T, tensor2: T, out: Optional[T] = None) -> Union[float, T]: ...
def matmul(tensor1: TV, tensor2: TV, out: Optional[TV] = None) -> Union[float, TV]: ...
