  ...
  const description = (
    <span>
      ...
      <span>
        ...
        Rather than pre-trained Glove vectors, this model uses <a href="Deep contextualized word representations">ELMo embeddings</a>, which are completely character based and improve performance by 2%
      </span>
    </span>
  );
