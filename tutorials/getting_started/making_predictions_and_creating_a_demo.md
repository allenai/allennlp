...
tutorial. All the code for that model is [on GitHub](https://github.com/allenai/allennlp-as-a-library-example/tree/0.4.0).
...
[as a test fixture](https://github.com/allenai/allennlp-as-a-library-example/tree/0.4.0/tests/fixtures).
...
[`text_to_instance`](https://github.com/allenai/allennlp-as-a-library-example/blob/0.4.0/my_library/dataset_readers/semantic_scholar_papers.py#L68)
method, which means all we have to do is extract what that method needs from the JSON.

This means our predictor [can be very simple](https://github.com/allenai/allennlp-as-a-library-example/blob/0.4.0/my_library/predictors/paper_classifier_predictor.py):
...
[`my_library/__init__.py`](https://github.com/allenai/allennlp-as-a-library-example/blob/0.4.0/my_library/__init__.py),
...
[`static_html`](https://github.com/allenai/allennlp-as-a-library-example/tree/0.4.0/static_html)
and saved `index.html` there. The original page had a lot of embedded CSS, which I split out into
[its own file](https://github.com/allenai/allennlp-as-a-library-example/blob/0.4.0/static_html/demo.css).
...
To start with, we need to [add a `script` tag to load chart.js](https://github.com/allenai/allennlp-as-a-library-example/blob/0.4.0/static_html/index.html#L47).
...
[placing that inside our `output` div](https://github.com/allenai/allennlp-as-a-library-example/blob/0.4.0/static_html/index.html#L61):
