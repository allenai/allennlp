...
from allennlp.models.encoder_decoders.ratecalculus.ratecalculus_decoder_state import RateCalculusDecoderState
...
class RateCalculusDecoderStep(DecoderStep[RateCalculusDecoderState]):
    def __init__(self,
        ...
        super(RateCalculusDecoderStep, self).__init__()
    ...
    @overrides
    def take_step(self,
                  state: RateCalculusDecoderState,
                  max_actions: int = None,
                  allowed_actions: List[Set[int]] = None) -> List[RateCalculusDecoderState]:
    ...
    @staticmethod
    def _get_actions_to_consider(state: RateCalculusDecoderState) -> Tuple[List[List[int]],
                                                                         List[List[int]],
                                                                         List[List[int]]]:
        """
        The ``RateCalculusDecoderState`` defines a set of actions that are valid in the current
    ...
    @staticmethod
    def _get_action_embeddings(state: RateCalculusDecoderState,
    ...
    def _get_entity_action_logits(self,
        ...
        scores between the question and the knowledge graph entities, and the current attention on the
    ...
    @staticmethod
    def _compute_new_states(state: RateCalculusDecoderState,
                            ...
                            max_actions: int = None) -> List[RateCalculusDecoderState]:
        ...
        for batch_index, best_states in sorted(best_next_states.items()):
            ...
            for group_index, action_index, action in best_states:
                ...
                new_state = RateCalculusDecoderState(batch_indices=[batch_index],
