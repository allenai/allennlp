...
class RateCalculusSemanticParser(Model):
    ...
    ``RateCalculusErmSemanticParser``, or if you have a set of approximate logical forms that give the
    correct denotation, you will want to use ``RateCalculusMmlSemanticParser``.
