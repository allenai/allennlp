...
class RateCalculusDecoderStep(DecoderStep[RateCalculusDecoderState]):
    ...
    def take_step(self,
        ...
        new_states = self._compute_new_states(state,
                                        log_probs,
                                        hidden_state,
                                        memory_cell,
        ...
        #    new_state.print_action_history(0)
        #print("-------")
        return new_states

    @staticmethod
    def _get_checklist_balance(state: RateCalculusDecoderState,
    ...
    @staticmethod
    def _get_predicted_embedding_addition(state: RateCalculusDecoderState,
                                          unlinked_terminal_indices: List[int],
