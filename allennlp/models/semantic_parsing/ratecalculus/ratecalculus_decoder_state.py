...
class RateCalculusDecoderState(DecoderState['RateCalculusDecoderState']):
    """
    Parameters
    ----------
    ...
    world : ``List[RateCalculusWorld]``, optional (default=None)
    ...
    def __init__(self,
                 ...
                 actions_to_entities: Dict[Tuple[int, int], int],
                 entity_types: Dict[int, int],
                 world: List[RateCalculusWorld] = None,
                 example_lisp_string: List[str] = None,
                 checklist_state: List[ChecklistState] = None,
                 debug_info: List = None) -> None:
        super(RateCalculusDecoderState, self).__init__(batch_indices, action_history, score)
    ...
    @classmethod
    def combine_states(cls, states: List['RateCalculusDecoderState']) -> 'RateCalculusDecoderState':
        ...
        if states[0].debug_info is not None:
            ...
            debug_info = None
        return RateCalculusDecoderState(batch_indices=batch_indices,
