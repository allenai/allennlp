...
class BasicTransitionFunction(DecoderStep[GrammarBasedDecoderState]):
    """
    ...
    def take_step(self,
                  ...
                  allowed_actions: List[Set[int]] = None) -> List[GrammarBasedDecoderState]:
    ...
    def _update_decoder_state(self, state: GrammarBasedDecoderState) -> Dict[str, torch.Tensor]:
