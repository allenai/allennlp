...
class CoreferenceResolver(Model):
    ...
    num_coref_layers: int, optional (default = 1)
        The number of span representation refinement layers.
    lexical_dropout : `int`
    ...
    def forward(
        ...
        for _ in range(self._num_coref_layers - 1):
