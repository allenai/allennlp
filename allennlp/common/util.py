...
def threaded_generator(g: Iterable, maxsize: int = 8) -> Generator:
    """
    Wraps a generator such that next() is executed in a separate thread. The producing side will run ahead of the
    consuming side and cache up to `maxsize` results.
