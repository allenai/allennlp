...
class TeeLogger:
    ...
    """
    def __init__(self, filename: str, terminal: TextIO, clean_terminal_output: bool) -> None:
        self.terminal = terminal
        self.clean_terminal_output = clean_terminal_output
