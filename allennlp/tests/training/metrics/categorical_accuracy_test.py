...
class CategoricalAccuracyTest(AllenNlpTestCase):
    ...
    def test_positive_label_categorical_accuracy(self):
        label_accuracy = CategoricalAccuracy(positive_label=3)
        predictions = torch.Tensor([[0.35, 0.25, 0.1, 0.1, 0.2],
                                    [0.1, 0.6, 0.1, 0.2, 0.0],
                                    [0.3, 0.2, 0.1, 0.3, 0.1],
    ...
    def test_top_k_positive_label_categorical_accuracy(self):
        label_accuracy = CategoricalAccuracy(positive_label=3,
                                             top_k=2)
        predictions = torch.Tensor([[0.35, 0.25, 0.1, 0.1, 0.2],
                                    [0.1, 0.6, 0.1, 0.2, 0.0],
    ...
    def test_top_k_positive_label_categorical_accuracy_accumulates_and_resets_correctly(self):
        accuracy = CategoricalAccuracy(positive_label=3,
                                       top_k=2)
        predictions = torch.Tensor([[0.35, 0.25, 0.1, 0.1, 0.2],
                                    [0.1, 0.6, 0.1, 0.2, 0.0],
                                    [0.3, 0.2, 0.1, 0.3, 0.1],
    ...
    def test_top_k_positive_label_categorical_accuracy_respects_mask(self):
        accuracy = CategoricalAccuracy(positive_label=3,
                                       top_k=2)
        predictions = torch.Tensor([[0.35, 0.25, 0.1, 0.1, 0.2],
                                    [0.1, 0.6, 0.1, 0.2, 0.0],
    ...
    def test_top_k_positive_label_categorical_accuracy_works_for_sequences(self):
        accuracy = CategoricalAccuracy(positive_label=3,
                                       top_k=2)
        predictions = torch.Tensor([[[0.35, 0.25, 0.1, 0.1, 0.2],
                                     [0.1, 0.6, 0.1, 0.2, 0.0],
    ...
    def test_top_k_positive_label_categorical_accuracy_catches_exceptions(self):
        accuracy = CategoricalAccuracy(positive_label=3)
        predictions = torch.rand([5, 7])
        out_of_range_labels = torch.Tensor([10, 3, 4, 0, 1])
        with pytest.raises(ConfigurationError):
