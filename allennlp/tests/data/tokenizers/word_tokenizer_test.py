...
from allennlp.data.tokenizers.word_tokenizer import LettersDigitsSpacyWordTokenizer
from allennlp.data.tokenizers.word_tokenizer import SimpleSpacyWordTokenizer
from allennlp.data.tokenizers.word_tokenizer import SpacyWordTokenizer
from allennlp.data.tokenizers.word_tokenizer import OpenAISpacyWordTokenizer
from allennlp.data.tokenizers.word_tokenizer import BertBasicTokenizer


class TestSimpleSpacyWordTokenizer(AllenNlpTestCase):
    def setUp(self):
        super().setUp()
        self.word_tokenizer = SimpleSpacyWordTokenizer()
...
class TestLettersDigitsSpacyWordTokenizer(AllenNlpTestCase):
    def setUp(self):
        super().setUp()
        self.word_tokenizer = LettersDigitsSpacyWordTokenizer()
...
class TestSpacyWordTokenizer(AllenNlpTestCase):
    def setUp(self):
        super().setUp()
        self.word_tokenizer = SpacyWordTokenizer()
    ...
    def test_keep_spacy_tokens(self):
        word_tokenizer = SpacyWordTokenizer()
        sentence = "This should be an allennlp Token"
        tokens = word_tokenizer.tokenize(sentence)
        assert tokens
        assert all(isinstance(token, Token) for token in tokens)

        word_tokenizer = SpacyWordTokenizer(keep_spacy_tokens=True)
...
class TestOpenAiSpacyWordTokenizer(AllenNlpTestCase):
    def setUp(self):
        super().setUp()
        self.word_tokenizer = OpenAISpacyWordTokenizer()
...
class TestBertBasicTokenizer(AllenNlpTestCase):
    def setUp(self):
        super().setUp()
        self.word_tokenizer = BertBasicTokenizer()
    ...
    def test_do_lower_case(self):
        # BertBasicTokenizer makes every token not in `never_split` to lowercase by default
        word_tokenizer = BertBasicTokenizer(never_split=["[UNUSED0]"])
