...
class TestEvent2MindDatasetReader:
    ...
    def test_read(self, lazy):
        ...
        instances = reader.read(str(AllenNlpTestCase.FIXTURES_ROOT / "data" / "event2mind_small.csv"))
        ...
        assert get_text("source", instance) == ["@start@", "personx", "drives", "persony", "'s", "truck", "@end@"]
        ...
        assert get_text("source", instance) == ["@start@", "personx", "gets", "persony", "'s", "mother", "@end@"]
