...
class Text2SqlUtilsTest(AllenNlpTestCase):
    ...
    def test_process_sql_data_blob(self):
        ...
        dataset = text2sql_utils.process_sql_data_blob(data[0], cross_validation_split=1)
        ...
        dataset = text2sql_utils.process_sql_data_blob(data[1], cross_validation_split=1)
        ...
        for i, (split, sql_data) in enumerate(dataset):
            assert split == "train"
