...
class TestTemplateText2SqlDatasetReader(AllenNlpTestCase):
    def test_reader(self):
        ...
        assert (
            fields["template"].label == "SELECT COUNT ( * ) FROM LOCATION AS LOCATIONalias0 , RESTAURANT "
        ...
        assert (
            fields["template"].label == "SELECT COUNT ( * ) FROM GEOGRAPHIC AS GEOGRAPHICalias0 , RESTAURANT AS "
