...
class TestBeamSearch(AllenNlpTestCase):
    def test_search(self):
        ...
        best_states = beam_search.search(5, initial_state, decoder_step, keep_final_unfinished_states=False)
        ...
        best_states = beam_search.search(5, initial_state, decoder_step, keep_final_unfinished_states=True)
