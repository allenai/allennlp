...
from allennlp.models.reading_comprehension import DQA


class DQATest(ModelTestCase):
    def setUp(self):
        super(DQATest, self).setUp()
        self.set_up_model(self.FIXTURES_ROOT / 'dqa' / 'experiment.json',
                          self.FIXTURES_ROOT / 'data' / 'dqa_sample.json')
    ...
    def test_get_best_span(self):
        ...
        begin_end_idxs = DQA.get_best_span(span_begin_probs, span_end_probs)
