...
from allennlp.state_machines.states import AtisGrammarBasedState, GrammarStatelet, RnnStatelet
...
class AtisDecoderStepTest(AllenNlpTestCase):
    ...
    def test_atis_grammar_state(self):
        ...
        grammar_state = AtisGrammarBasedState(['stmt'], {}, valid_actions, {}, is_nonterminal)
