...
class NlvrWorld(World):
    ...
    def get_logical_form(self,
        ...
        """
        # TODO(pradeep): This method almost works with LambdaDCS logical forms in WikiTables as
        # well. The thing that breaks it is "reverse", which is a higher order function. Once I
