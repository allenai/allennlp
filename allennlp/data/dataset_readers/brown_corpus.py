...
@DatasetReader.register("brown_corpus")
class BrownCorpusDatasetReader(DatasetReader):
    """
    Reads instances from the Brown Corpus where each line is in the following format:
    ...
    def read(self, file_path):
        with open(file_path, "r") as data_file:
            ...
            for line in tqdm.tqdm(data_file):
                ...
                tokens_and_tags = [pair.split("/") for pair in line.split()]
    ...
    def from_params(cls, params: Params) -> 'BrownCorpusDatasetReader':
        ...
        return BrownCorpusDatasetReader(token_indexers=token_indexers)
