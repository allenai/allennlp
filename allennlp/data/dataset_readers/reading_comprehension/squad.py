...
from allennlp.data.tokenizers import Token, Tokenizer, SpacyWordTokenizer
...
class SquadReader(DatasetReader):
    ...
    Parameters
    ----------
    tokenizer : ``Tokenizer``, optional (default=``SpacyWordTokenizer()``)
        We use this ``Tokenizer`` for both the question and the passage.  See :class:`Tokenizer`.
        Default is ```SpacyWordTokenizer()``.
    ...
    def __init__(
        ...
        super().__init__(lazy)
        self._tokenizer = tokenizer or SpacyWordTokenizer()
