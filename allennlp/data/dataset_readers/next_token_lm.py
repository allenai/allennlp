...
from allennlp.data.tokenizers.word_tokenizer import JustSpacesTokenizer
...
class NextTokenLmReader(DatasetReader):
    ...
    Parameters
    ----------
    tokenizer : ``Tokenizer``, optional (default=``JustSpacesTokenizer()``)
    ...
    def __init__(
        ...
        super().__init__(lazy)
        self._tokenizer = tokenizer or JustSpacesTokenizer()
