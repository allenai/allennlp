...
@Metric.register("multi-squad")
class MultiSquadEmAndF1(Metric):
    """
    ...
    def __call__(self, best_span_strings, answer_strings):
        ...
        exact_match = 0.0
        f1_score = 0.0
        for best_span_string in best_span_strings:
    ...
    def __str__(self):
        return f"MultiSquadEmAndF1(em={self._total_em}, f1={self._total_f1})"
