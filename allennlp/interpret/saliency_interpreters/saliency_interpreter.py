...
class SaliencyInterpreter(Registrable):
    ...
    def saliency_interpret_from_json(self, inputs: JsonDict) -> JsonDict:
        ...
        -------
        JsonDict
        Contains the normalized saliency values for each input token. The dict has entries for each instance
        in the inputs JsonDict, e.g., {instance_1: ..., instance_2:, ... }. Each one of those entries
        has entries for the saliency of the inputs, e.g., {grad_input_1: ..., grad_input_2: ... }.
        """
