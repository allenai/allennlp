...
class IntegratedGradient(SaliencyInterpreter):
  ...
  def _register_forward_hook(self, alpha: int, embeddings_list: List):
    ...
    We store the embedding output into the embeddings_list when alpha is zero. This is used later to element-wise multiply the input by the averaged gradients. 
    """
