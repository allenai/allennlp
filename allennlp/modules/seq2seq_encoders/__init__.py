...
class _Wrapper:
    ...
    the interface between a pytorch RNN and our ``Seq2SeqEncoder`` API.  Our ``WrappedPytorchRnn``
...
Registry.register_seq2seq_encoder("gru")(_Wrapper(torch.nn.GRU))
Registry.register_seq2seq_encoder("lstm")(_Wrapper(torch.nn.LSTM))
Registry.register_seq2seq_encoder("rnn")(_Wrapper(torch.nn.RNN))
