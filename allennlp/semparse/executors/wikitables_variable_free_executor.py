...
class WikiTablesVariableFreeExecutor:
    ...
    def select(self, expression_list: NestedList) -> List[str]:
        """
    ...
    def argmax(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        ...
        if self._values_look_like_dates(expression_list):
            value_row_pairs = self._get_date_row_pairs_to_filter(expression_list)
        else:
            value_row_pairs = self._get_number_row_pairs_to_filter(expression_list)  # type: ignore
        if not value_row_pairs:
            return []
        # Returns a list containing the row with the max cell value.
        return [sorted(value_row_pairs, reverse=True)[0][1]]

    def argmin(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes a list of rows and a column (decoded from the `expression_list`) and returns a list
    ...
    def filter_number_greater(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
    ...
    def filter_number_greater_equals(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes a list of rows, a column, and a numerical value (decoded from `expression_list`) and
    ...
    def filter_number_lesser(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes a list of rows, a column, and a numerical value (decoded from `expression_list`) and
    ...
    def filter_number_lesser_equals(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes a list of rows, a column, and a numerical value (decoded from `expression_list`) and
    ...
    def filter_number_equals(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes a list of rows, a column, and a numerical value (decoded from `expression_list`) and
    ...
    def filter_number_not_equals(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes a list of rows, a column, and a numerical value (decoded from `expression_list`) and
    ...
    def filter_date_greater(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
    ...
    def filter_date_greater_equals(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes a list of rows, a column, and a date value (decoded from `expression_list`) and
        returns all the rows where the value in that column is greater than or equal to the given value.
        """
    ...
    def filter_date_lesser(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes a list of rows, a column, and a date value (decoded from `expression_list`) and
        returns all the rows where the value in that column is lesser than the given value.
        """
    ...
    def filter_date_lesser_equals(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes a list of rows, a column, and a date value (decoded from `expression_list`) and
        returns all the rows where the value in that column is lesser than or equal to the given value.
        """
    ...
    def filter_date_equals(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes a list of rows, a column, and a date value (decoded from `expression_list`) and
        returns all the rows where the value in that column equals the given value.
        """
    ...
    def filter_date_not_equals(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes a list of rows, a column, and a date value (decoded from `expression_list`) and
        returns all the rows where the value in that column is not equal to the given value.
        """
    ...
    def filter_in(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
    ...
    def filter_not_in(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes a list of rows, a column, and a string value (decoded from `expression_list`) and
    ...
    def first(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
    ...
    def last(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
    ...
    def previous(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
    ...
    def next(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
        Takes an expression that evaluates to a single row, and returns the row (as a list to be
    ...
    def count(self, expression_list: NestedList) -> float:
        """
    ...
    def max(self, expression_list: NestedList) -> float:
        """
    ...
    def min(self, expression_list: NestedList) -> float:
        """
    ...
    def sum(self, expression_list: NestedList) -> float:
        """
    ...
    def average(self, expression_list: NestedList) -> float:
        """
    ...
    def mode(self, expression_list: NestedList) -> List[str]:
        """
    ...
    def same_as(self, expression_list: NestedList) -> List[Dict[str, str]]:
        """
    ...
    def diff(self, expression_list: NestedList) -> float:
        """
    ...
    @staticmethod
    def date(expression_list: NestedList) -> Date:
        """
