  ...
  <head>
    ...
    <style>
        * {
        ...
        .tree li section:focus+ul li::before
        .tree li section:hover+ul::before,
        .tree li section:focus+ul::before
        .tree li section:hover+ul ul::before,
...
const Configurator = ({path, item, setData}) => {
    ...
    prefix = (prefix && prefix.length) ? prefix.substring(0, prefix.length - 1): null; // remove last dot
