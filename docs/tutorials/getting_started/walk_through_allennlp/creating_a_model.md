...
[`DatasetReader`](https://allenai.github.io/allennlp-docs/0.9.0/api/allennlp.data.dataset_readers.html)
subclass to read in your datasets and a
[`Model`](https://allenai.github.io/allennlp-docs/0.9.0/api/allennlp.models.model.html)
...
[span-based F1](https://allenai.github.io/allennlp-docs/0.9.0/api/allennlp.training.metrics.html#span-based-f1-measure)
...
As the CRF is just a component of our model, we'll implement it as a [Module](https://allenai.github.io/allennlp-docs/0.9.0/api/allennlp.modules.html).
