...
local vocabulary = if construct_vocab then {
      ...
      "type": "from_files",
      "directory": "https://storage.googleapis.com/allennlp-public-data/vqav2/vilbert_vqa_abstract_scenes.vocab.tar.gz"
    };

{
  "dataset_reader": {
    "type": "vqav2",
    "image_dir": "/mnt/tank/dirkg/data/vision/vqa/binary_abstract_scenes",
    "feature_cache_dir": "/mnt/tank/dirkg/data/vision/vqa/binary_abstract_scenes/feature_cache",
    #"image_dir": "/Users/dirkg/Documents/data/vision/vqa/binary_abstract_scenes",
    #"feature_cache_dir": "/Users/dirkg/Documents/data/vision/vqa/binary_abstract_scenes/feature_cache",
