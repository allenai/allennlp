...
def main(argv):
    ...
    output_lang, pairs, pairs_dev, max_length = initializeData('data/wsj.unlabeled.elmo.train.txt', 'data/wsj.unlabeled.elmo.dev.txt')  
      
    hidden_size = 1029
    encoder1 = EncoderRNNElmo(hidden_size, device=-1, n_layers = 2) #change for cuda
    ...
    trainItersElmo(encoder1, attn_decoder1, output_lang, 150000, pairs, pairs_dev, max_length, print_every=1000)
    # experimental
