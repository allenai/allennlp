...
class TestTextClassificationJsonReader:
    ...
    def test_read_from_file_ag_news_corpus_and_test_key_and_label_key(self):
        reader = TextClassificationJsonReader(text_key="description", label_key="category")
        ag_path = (
            AllenNlpTestCase.FIXTURES_ROOT
            / "data"
            / "text_classification_json"
            / "ag_news_corpus_test_key_name.jsonl"
        )
        instances = list(reader.read(ag_path))
        is_version_3 = spacy.__version__ >= "3.0"
