...
class TestEncoderBase(AllenNlpTestCase):
    ...
    def test_non_stateful_states_are_sorted_correctly(self):
        ...
        initial_states = (torch.autograd.Variable(torch.randn(6, 5, 7)),
                         torch.autograd.Variable(torch.randn(6, 5, 7)))
        ...
        zeros =torch.autograd.Variable(torch.zeros([6, 2, 7]))
    ...
    def test_get_initial_states(self):
        ...
        initial_states = (torch.autograd.Variable(torch.randn([1, 3, 7])),torch.autograd.Variable(torch.randn([1, 3, 7])))
        ...
        correct_expanded_states = [torch.cat([state,torch.autograd.Variable(torch.zeros([1, 2, 7]))], 1)
        ...
        original_states = (torch.autograd.Variable(torch.randn([1, 10, 7])),torch.autograd.Variable(torch.randn([1, 10, 7])))
    ...
    def test_update_states(self):
        ...
        initial_states = (torch.autograd.Variable(torch.randn([1, 5, 7])),
                         torch.autograd.Variable(torch.randn([1, 5, 7])))
        ...
        new_states = (torch.autograd.Variable(torch.randn([1, 5, 7])),
                     torch.autograd.Variable(torch.randn([1, 5, 7])))
        ...
        small_new_states = (torch.autograd.Variable(torch.randn([1, 3, 7])),
                           torch.autograd.Variable(torch.randn([1, 3, 7])))
        # pretend the 2nd sequence in the batch was fully masked.
        small_restoration_indices =torch.autograd.Variable(torch.LongTensor([2, 0, 1]))
