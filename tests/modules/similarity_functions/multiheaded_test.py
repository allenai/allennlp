...
class TestMultiHeadedSimilarityFunction(AllenNlpTestCase):
    ...
    def test_forward(self):
        ...
        a_vectors =torch.autograd.Variable(torch.FloatTensor([[[[1, 1, -1, -1, 0, 1], [-2, 5, 9, -1, 3, 4]]]]))
        b_vectors =torch.autograd.Variable(torch.FloatTensor([[[[1, 1, 1, 0, 2, 5], [0, 1, -1, -7, 1, 2]]]]))
