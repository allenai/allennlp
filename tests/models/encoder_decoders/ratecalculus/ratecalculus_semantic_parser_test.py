...
from allennlp.models import Model, RateCalculusSemanticParser
...
class RateCalculusSemanticParserTest(ModelTestCase):
    def setUp(self):
        ...
        self.set_up_model("tests/fixtures/encoder_decoder/ratecalculus_semantic_parser/experiment.json",
                          "tests/fixtures/data/ratecalculus/sample_data.json")
