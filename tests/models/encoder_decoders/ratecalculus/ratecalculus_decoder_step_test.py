...
from allennlp.models.encoder_decoders.ratecalculus.ratecalculus_decoder_step import RateCalculusDecoderStep
from allennlp.modules import SimilarityFunction
from allennlp.nn.decoding import GrammarState, RnnState


class RateCalculusDecoderStepTest(AllenNlpTestCase):
    def setUp(self):
        super().setUp()
    ...
    def test_get_actions_to_consider(self):
        ...
        considered, to_embed, to_link = RateCalculusDecoderStep._get_actions_to_consider(self.state)
